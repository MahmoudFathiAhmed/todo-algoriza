...
import 'package:todo_algoriza/presentation/favourites/widgets/task_item_favourites.dart';
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                if (task.repeat == 'Daily' ||
                  ...
                  return GestureDetector(
                    ...
                    child: TaskItemBoardFavourites(task,onPressed: () => showBottomSheet(context, task),),
                  );
                } else {
                  return Container();
                }
