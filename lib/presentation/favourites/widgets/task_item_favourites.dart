...
class TaskItemBoardFavourites extends StatelessWidget {
  const TaskItemBoardFavourites(this.task, {Key? key, required this.onPressed}) : super(key: key);
      ...
      children: [
        Expanded(
          child: SingleChildScrollView(
            child: Row(
              children: [
                task.isFavourite == 1 ?NonCheckedWidget(color: getTaskClr(task.color), onTab: (){}):
